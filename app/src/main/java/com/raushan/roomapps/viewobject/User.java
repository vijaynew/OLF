...
public class User {
    ...
    public User(@NonNull String userId, String userIsSysAdmin, String isCityAdmin, String facebookId, String userName, String userEmail, String userPhone, String userAddress, String city, String userPassword, String userAboutMe, String userCoverPhoto, String userProfilePhoto, String roleId, String status, String isBanned, String addedDate, String deviceToken, String code, String overallRating, String whatsapp, String messenger, String followerCount, String followingCount, String isFollowed, String added_date_str, String verifyTypes, String ratingCount, RatingDetail ratingDetails) {
        this.userId = userId;
